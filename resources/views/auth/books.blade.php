    ...
    <div class="container mx-auto mt-10 p-5 bg-gray-800 rounded-lg shadow-lg">
        ...
        <form action="{{ route('books.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" class="form-input border border-gray-600 rounded w-full py-2 px-3 bg-gray-700 text-white placeholder-gray-400 focus:outline-none focus:border-blue-500" id="issn_isbn" name="issn_isbn" placeholder="Enter ISSN/ISBN" required>
            </div>
            <div class="mb-4">
                <label for="no_of_pages" class="block text-white font-bold mb-2">No of Pages</label>
                <input type="number" class="form-input border border-gray-600 rounded w-full py-2 px-3 bg-gray-700 text-white placeholder-gray-400 focus:outline-none focus:border-blue-500" id="no_of_pages" name="no_of_pages" placeholder="Enter number of pages" required>
            </div>
